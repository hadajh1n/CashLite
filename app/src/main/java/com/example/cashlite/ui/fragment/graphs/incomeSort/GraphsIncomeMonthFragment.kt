package com.example.cashlite.ui.fragment.graphs.incomeSort
...
import com.example.cashlite.databinding.FragmentGraphsIncomeMonthBinding
import com.example.cashlite.ui.viewModel.graphs.incomeSort.GraphsIncomeMonthViewModel
...
class GraphsIncomeMonthFragment : Fragment() {

    private var _binding: FragmentGraphsIncomeMonthBinding? = null
    private val binding get() = _binding!!

    private val viewModel: GraphsIncomeMonthViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentGraphsIncomeMonthBinding.inflate(inflater, container, false)
        return binding.root
    }
