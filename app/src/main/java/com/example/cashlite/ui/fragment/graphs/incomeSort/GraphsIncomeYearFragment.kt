...
import com.example.cashlite.databinding.FragmentGraphsIncomeYearBinding
import com.example.cashlite.ui.viewModel.graphs.incomeSort.GraphsIncomeYearViewModel
...
class GraphsIncomeYearFragment : Fragment() {

    private var _binding: FragmentGraphsIncomeYearBinding? = null
    private val binding get() = _binding!!

    private val viewModel: GraphsIncomeYearViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentGraphsIncomeYearBinding.inflate(inflater, container, false)
        return binding.root
    }
