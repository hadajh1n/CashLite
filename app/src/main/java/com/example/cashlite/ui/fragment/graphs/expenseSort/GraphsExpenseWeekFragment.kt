...
import com.example.cashlite.databinding.FragmentGraphsExpenseWeekBinding
import com.example.cashlite.ui.viewModel.graphs.expenseSort.GraphsExpenseWeekViewModel
...
class GraphsExpenseWeekFragment : Fragment() {

    private var _binding: FragmentGraphsExpenseWeekBinding? = null
    private val binding get() = _binding!!

    private val viewModel: GraphsExpenseWeekViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentGraphsExpenseWeekBinding.inflate(inflater, container, false)
        return binding.root
    }
