...
import com.example.cashlite.databinding.FragmentGraphsIncomeWeekBinding
import com.example.cashlite.ui.viewModel.graphs.incomeSort.GraphsIncomeWeekViewModel
...
class GraphsIncomeWeekFragment : Fragment() {

    private var _binding: FragmentGraphsIncomeWeekBinding? = null
    private val binding get() = _binding!!

    private val viewModel: GraphsIncomeWeekViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentGraphsIncomeWeekBinding.inflate(inflater, container, false)
        return binding.root
    }
