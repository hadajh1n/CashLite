...
import com.example.cashlite.databinding.FragmentGraphsExpenseMonthBinding
import com.example.cashlite.ui.viewModel.graphs.expenseSort.GraphsExpenseMonthViewModel
...
class GraphsExpenseMonthFragment : Fragment() {

    private var _binding: FragmentGraphsExpenseMonthBinding? = null
    private val binding get() = _binding!!

    private val viewModel: GraphsExpenseMonthViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        _binding = FragmentGraphsExpenseMonthBinding.inflate(inflater, container, false)
        return binding.root
    }
